...
export const ATTACK_DEFINITIONS: AttackDefinition[] = [
  ...
  { name: 'Encoding Attack', category: 'security' },
  { name: 'Structure Attack', category: 'security' },
  { name: 'Indirect Injection', category: 'security' },
  { name: 'Multi-Turn Attack', category: 'security' },
  { name: 'Language Attack', category: 'security' },
  ...
  { name: 'Off-Topic Handler', category: 'reliability' },
